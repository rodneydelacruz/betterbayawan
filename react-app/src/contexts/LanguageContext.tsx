...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'footer-lgu-portal': 'LGU Bayawan City Portal',
  ...
  fil: {
    ...
    'weather-location': 'Bayawan City, Negros Oriental',
    'weather-code-0': 'Maaliwalas na langit',
    'weather-code-1': 'Halos maaliwalas',
    'weather-code-2': 'Bahagyang maulap',
    'weather-code-3': 'Maulap',
    'weather-code-45': 'Hamog',
    'weather-code-48': 'Hamog na namumuo',
    'weather-code-51': 'Mahinang ambon',
    'weather-code-53': 'Katamtamang ambon',
    'weather-code-55': 'Makapal na ambon',
    'weather-code-61': 'Mahinang ulan',
    'weather-code-63': 'Katamtamang ulan',
    'weather-code-65': 'Malakas na ulan',
    'weather-code-80': 'Pag-ambon ng ulan',
    'weather-code-95': 'Kulog at kidlat',
    ...
    'footer-lgu-portal': 'Portal ng LGU Bayawan City',
    'footer-sb': 'Sangguniang Panlungsod',
    'footer-lgu-facebook': 'LGU Bayawan City Facebook',
    'footer-blgf': 'BLGF Portal',
    'footer-cmci': 'CMCI DTI Portal',
  ...
  bis: {
    ...
    'weather-location': 'Bayawan City, Negros Oriental',
    'weather-code-0': 'Hawan nga langit',
    'weather-code-1': 'Halos tin-aw',
    'weather-code-2': 'Dag-om-om',
    'weather-code-3': 'Madag-om',
    'weather-code-45': 'Gabon',
    'weather-code-48': 'Gabon nga nagyelo',
    'weather-code-51': 'Gaan nga taligsik',
    'weather-code-53': 'Tunga-tunga nga taligsik',
    'weather-code-55': 'Kabaga-bagang taligsik',
    'weather-code-61': 'Gaan nga ulan',
    'weather-code-63': 'Tunga-tunga nga ulan',
    'weather-code-65': 'Kusog nga ulan',
    'weather-code-80': 'Ambon-ambon nga ulan',
    'weather-code-95': 'Kilat ug dalugdog',
