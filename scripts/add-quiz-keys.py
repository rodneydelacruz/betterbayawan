#!/usr/bin/env python3
"""
Add missing ___Bayawan City_QUIZ___ and Quiz CTA translation keys to translations.js.
"""
...
# All the page-prefix variants for "___Bayawan City_QUIZ___" footer link
prefixes = [
...
quiz_cta_en = {
    'home-Bayawan City-quiz': '___Bayawan City_QUIZ___',
    'home-how-well-do-you-know-Bayawan City-nueva-vizcaya': 'How well do you know Bayawan City, Negros Oriental?',
    'home-evaluate-your-familiarity-with-the-municipalitys': "Evaluate your familiarity with the municipality's heritage, cultural identity, and geographic significance through an interactive knowledge assessment designed to showcase one of Negros Oriental's most prominent localities.",
    'home-take-the-quiz': 'Take the Quiz',
}

quiz_cta_fil = {
    'home-Bayawan City-quiz': '___Bayawan City_QUIZ___',
    'home-how-well-do-you-know-Bayawan City-nueva-vizcaya': 'Gaano mo kakilala ang Bayawan City, Negros Oriental?',
...
quiz_cta_bis = {
    'home-Bayawan City-quiz': '___Bayawan City_QUIZ___',
    'home-how-well-do-you-know-Bayawan City-nueva-vizcaya': 'Kasano ti pannakaammom iti Bayawan City, Negros Oriental?',
    'home-evaluate-your-familiarity-with-the-municipalitys': "Evaluaren ti pannakaammom iti tawid, kultural a pagbigbigan, ken heograpiko a kapatgan ti munisipalidad babaen ti maysa nga interactive a panagsubok ti pannakaammo a naidisinio tapno ipakita ti maysa kadagiti kalatakan a lokalidad ti Negros Oriental.",
...
def build_entries(lang):
    ...
    # Page-prefix ___Bayawan City_QUIZ___ keys
    for prefix in prefixes:
        key = f'{prefix}-Bayawan City-quiz'
        # "___Bayawan City_QUIZ___" stays the same in all languages (it's a proper name)
        entries.append(f'        "{key}": "___Bayawan City_QUIZ___"')
    
    # Quiz CTA keys
    if lang == 'en':
        for k, v in quiz_cta_en.items():
            # Skip home-Bayawan City-quiz since it's already in the prefix list
            if k == 'home-Bayawan City-quiz':
                continue
...
for k in ['home-take-the-quiz', 'home-how-well-do-you-know-Bayawan City-nueva-vizcaya']:
