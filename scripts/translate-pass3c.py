...
FIXES_FIL = {
    ...
    "The City Budget Office assists the different schools in the preparation of SEF Annual Budget. It assists the Municipal School Board in the conduct of budget hearings and deliberations of budget proposals. It ensures compliance with statutory, contractual obligations and budgetary requirements prior to the review and approval by the Municipal School Board (MSB).":
...
def build_bis_from_fil(fil_val):
    """Convert Filipino to Bisaya using word substitutions."""
    fil_to_bis = {
...
def main():
    ...
    print(f"  bis: {total - untrans_ilo}/{total} translated ({(total-untrans_ilo)/total*100:.1f}%), {untrans_ilo} untranslated")
