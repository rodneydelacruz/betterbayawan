...
FIXES = {
    ...
    "The City General Services Office manages and maintains municipal vehicles":
...
def main():
    ...
    for key in en:
        ...
        if 'AS IS' in en_val and 'warranty' in en_val and '\\\\' in fil_val:
            ...
            bis[key] = 'Ti amin nga impormasion iti daytoy a website ket maipaay a \\"AS IS\\" nga awan ti warranty ti aniaman a kita, hayag man wenno ipinahiwatig. Karaman ditoy ngem saan a limitado iti:'
            fixed += 1
